    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarContent">
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                ...
                <li class="nav-item"><a class="nav-link" href="#contactusfrm">Contact</a></li>
...
<div class="container mt-5">
    <h1 class="text-center display-4">Meet Our Trainers</h1>
    
    <div class="row mt-4">
        <!-- Left Column: Display Trainers -->
        <div class="col-lg-6 col-md-12 mb-4">
            <div class="row row-cols-1 row-cols-md-2 g-4">
                <!-- Manually Added Trainers -->
                <div class="col">
                    <div class="card">
                        <img src="images/trainers/john.jpg" class="card-img-top" alt="John Doe">
                        <div class="card-body">
                ...
                <div class="col">
                    <div class="card">
                        <img src="images/trainers/alex.jpg" class="card-img-top" alt="Alex King">
                        <div class="card-body">
                ...
                <div class="col">
                    <div class="card">
                        <img src="images/trainers/lisa.jpg" class="card-img-top" alt="Lisa Smith">
                        <div class="card-body">
                ...
                <div class="col">
                    <div class="card">
                        <img src="images/trainers/emma.jpg" class="card-img-top" alt="Emma Taylor">
                        <div class="card-body">
        ...
        <!-- Right Column: Trainer Enrollment Form -->
        <div class="col-lg-6 col-md-12 mb-4">
